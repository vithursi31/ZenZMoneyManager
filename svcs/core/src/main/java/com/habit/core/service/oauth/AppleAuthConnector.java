...
public class AppleAuthConnector {
    ...
    @Value("${habit.apple.client-id:}")     private String clientIdMobile;
    @Value("${habit.apple.client-id-web:}") private String clientIdWeb;
    @Value("${habit.apple.team-id:}")       private String teamId;
    @Value("${habit.apple.key-id:}")        private String keyId;
    @Value("${habit.apple.private-key:}")   private String privateKeyB64;
